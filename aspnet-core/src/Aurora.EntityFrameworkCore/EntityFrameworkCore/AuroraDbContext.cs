...
namespace Aurora.EntityFrameworkCore
{
     ...
     * used modules (as explained above). See AuroraMigrationsDbContext for migrations.
     */
    ...
    public class AuroraDbContext : AbpDbContext<AuroraDbContext>
    {
         ...
         * Also map them inside AuroraDbContextModelCreatingExtensions.ConfigureAurora
         */
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<AppUser>(b =>
            {
                 ...
                 * Also see the AuroraEfCoreEntityExtensionMappings class
                 */
            });
